...
<!-- ** CSS ** -->
    ...
    <script type="text/javascript" src="js_scripts/WimaxForALU_ipconfig.js"></script> 
	<script type="text/javascript" src="../ipautomation/scripts/NNIForALU_ipconfig.js"></script>
	...
	<script type="text/javascript" src="../ipautomation/scripts/EthOnSwitchWTx_ipconfig.js"></script>
	
	<script type="text/javascript" src="../ipautomation/scripts/EthOnRouterWOTx.js"></script>
	<script type="text/javascript" src="../ipautomation/scripts/EthOnRouterWTx_ipconfig.js"></script>
    ...
    <script type="text/javascript" src="../ipautomation/scripts/SerialchanlSTMKLM_ipconfig.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/PosPortDirectToRouter.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/MultipleVlanUpgrade_ipconfig.js"></script>
	...
	<script type="text/javascript" src="../ipautomation/scripts/Elan04Card_ipconfig.js"></script>
	<script type="text/javascript" src="../ipautomation/scripts/Sme_ipconfig.js"></script>
	<script type="text/javascript" src="../ipautomation/scripts/PDHDedicatedE1_ipconfig.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/DedicatedE1OvrChanlSTM_ipconfig.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/N64KDedicatedE1_ipconfig.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/N64KDedicatedE1OvrChanlSTM_ipconfig.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/RoadWarrior.js"></script>
    <script type="text/javascript" src="../ipautomation/scripts/illidcwotx.js"></script>
	<script type="text/javascript" src="../ipautomation/scripts/vutm.js"></script>
	<script type="text/javascript" src="../ipautomation/scripts/EthernetScenario_ipconfig.js"></script>
