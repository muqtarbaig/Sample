...
Ext.onReady(function(){
	...
	function vlanNameGenerationNNI() {
		...
		if (Ext.getCmp('specialQosLoopingReqdNni-id').checked == false) {
			//interfaceName = "Vlan";
...
//									{
//										xtype: 'checkbox',
//										name: 'nniVLANAssociatedtoServiceIDProt',
//										id: 'nniVLANAssociatedtoServiceIDProt-id',
//										fieldLabel: 'VLAN already reserved',
//										listeners:{
//												 	check : function()
//												 	{//backup
////														if(Ext.getCmp('nniVLANAssociatedtoServiceIDProt-id').checked == true){
////															Ext.getCmp('reserveNNI').disable();
////															Ext.getCmp('createCircuitNNI-id').enable();								
////														}
////														if(Ext.getCmp('nniVLANAssociatedtoServiceIDProt-id').checked == false){
////															Ext.getCmp('createCircuitNNI-id').disable();
////															Ext.getCmp('reserveNNI').enable();
////														}
//													}
...
nniWin = new Ext.Window({
				        ...
				        buttons: [{
				        	...
				        	alert(Ext.get('routerToCloudPortName-id').dom.value);
				            ...
				            Ext.Ajax.request({			            			
											...
											params : { method : 'createCircuitNni',
													   ...
													   peRouterPortName: Ext.get('routerToCloudPortName-id').dom.value,
